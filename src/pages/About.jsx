        ...
        <Container className="text-light mx-auto mx-3">
          ...
          <div>
            <Row className="pt-4">
              ...
              <Col sm={9} className="text-secondary opacity-100">Muhammad Ali</Col>
            </Row>
            <Row className="pt-2">
              <Col sm={3} className="fw-bold">Date Of Birth</Col>
              <Col sm={9} className="text-secondary opacity-100">March 20, 2001</Col>
            </Row>
            <Row className="pt-2">
              <Col sm={3} className="fw-bold">Address</Col>
              <Col sm={9} className="text-secondary opacity-100">Punjab Lahore</Col>
            </Row>
            <Row className="pt-2">
              <Col sm={3} className="fw-bold">Email</Col>
              <Col sm={9} className="text-secondary opacity-100">muhammadali0030@yahoo.com</Col>
            </Row>
            <Row className="pt-2">
              <Col sm={3} className="fw-bold">Phone</Col>
              <Col sm={9} className="text-secondary opacity-100">+923489310772</Col>
            </Row>
            <div className="mt-4">
